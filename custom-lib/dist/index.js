  ...
  handleValidation(event) {
    ...
    if (type == "text") {
      if (validation && value.length === 0) {
        ...
        this.setState({
          error: `${type} field cannot contain numbers.`
        });
      } else if (validation && value.length > 15) {
        this.setState({
          error: `${type} field cannot exceed 15 characters.`
        });
      } else {
        this.setState({
          error: ""
    ...
    if (type == "email") {
      if (validation && value.length === 0) {
        ...
        this.setState({
          error: `${type} field must be a valid email address.`
        });
      } else {
        this.setState({
          error: ""
    ...
    if (type == "password") {
      if (validation && value.length === 0) {
        ...
        this.setState({
          error: `${type} must be atleast 6 characters.`
        });
      } else {
        this.setState({
          error: ""
    ...
    if (type === "file" && event.target.files && event.target.files.length > 0) {
      if (event.target.files[0].size <= 1000000) {
        ...
        this.setState({
          error: `${type} size cannot exceed 1MB.`
        });
      }
    }
  }
