...
var Button = function Button(_a) {
  ...
  return React.createElement(React.Fragment, null, React.createElement(Typography.Typography, {
    ...
    ref: ref,
    style: style,
    className: "".concat(className, " button group ").concat(variant === "btn" && "!bg-[#D8D8D8] !text-[#6E6D7A]", " ").concat(variant === "btn-primary" && "!bg-[#02B89D] !text-white hover:!bg-[#029882]", " ").concat(variant === "btn-secondary" && "!bg-[#069CDE] !text-white hover:!bg-[#0281B9]", " ").concat(variant === "btn-success" && "!bg-[#198754] !text-white hover:!bg-[#146C43]", " ").concat(variant === "btn-error" && "!bg-[#DC3545] !text-white hover:!bg-[#B02A37]", " ").concat(variant === "btn-warning" && "!bg-[#FFC107] !text-white hover:!bg-[#CC9A06]", " ").concat(variant === "primary" && "!text-[#02B89D]", " ").concat(variant === "secondary" && "!text-[#069CDE]", " ").concat(variant === "success" && "!text-[#198754]", " ").concat(variant === "error" && "!text-[#DC3545]", " ").concat(variant === "warning" && "!text-[#FFC107]", " ").concat(variant === "btn-outline" && "btn-outline", " ").concat(variant === "btn-outline-primary" && "btn-outline-primary hover:!bg-[#E0F8F4]", " ").concat(variant === "btn-outline-secondary" && "btn-outline-secondary hover:!bg-[#E5F5FC]", " ").concat(variant === "btn-outline-success" && "btn-outline-success hover:!bg-[#D1E7DD]", " ").concat(variant === "btn-outline-error" && "btn-outline-error hover:!bg-[#F8D7DA]", " ").concat(variant === "btn-outline-warning" && "btn-outline-warning hover:!bg-[#FFF3CD]"),
    type: type,
    disabled: disabled,
    onBlur: onBlur,
    onChange: onChange,
