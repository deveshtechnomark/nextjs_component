...
var Toast = /** @class */function (_super) {
  ...
  Toast.showToast = function (type, message, text, duration) {
    ...
    toastElement.className = "flex flex-col text-base m-[6px] p-[12px] px-[16px] rounded-md text-white font-semibold min-w-15rem relative ".concat(type === "error" ? "bg-error !text-errorText" : type === "warning" ? "bg-warning !text-warningText" : type === "info" ? "bg-info !text-infoText" : "bg-success !text-successText");
