...
`;
    ...
    alertElement.className = `flex flex-col text-base m-[6px] p-[12px] px-[16px] rounded-md text-white font-semibold min-w-15rem relative ${type === "error" ? "bg-rose-200 !text-red-500" : type === "warning" ? "bg-amber-100 !text-yellow-900" : type === "info" ? "bg-indigo-50 !text-blue-700" : "bg-teal-500 !text-white"}`;
...
Alert.containerId = "fixed z-9999";
