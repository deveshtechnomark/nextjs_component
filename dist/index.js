...
var Alert = function Alert(_a) {
  ...
  return React.createElement(React.Fragment, null, visible && React.createElement("div", {
    ...
    className: "flex"
  }, React.createElement("span", null, variant === "error" ? errorIcon : variant === "warning" ? warningIcon : variant === "info" ? infoIcon : successIcon), React.createElement(Typography.Typography, {
    type: "sub-title",
