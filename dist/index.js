  ...
  render() {
    ...
    return react.createElement("div", {
      ...
      className: classnames("p-3 text-sm hover:bg-gray-200 font-normal cursor-pointer", {
        ...
        hidden: !option.label.toLowerCase().startsWith(inputValue) && !option.label.toLowerCase().includes(inputValue)
      }),
      onClick: () => {
...
class Select extends react.Component {
  ...
  render() {
    ...
    return react.createElement(react.Fragment, null, react.createElement("div", {
      ...
      className: classnames("text-sm font-normal text-CSSecondaryGray", open && "text-CSgreen"),
      htmlFor: "select"
    }, label), react.createElement("div", {
      ...
      className: classnames("flex-grow bg-white text-CSDarkGray p-2 text-[14px] font-normal", !inputValue && "text-CSDarkGray", open && "text-CSgreen", !open ? "cursor-pointer" : "cursor-default", "outline-none", !open ? "placeholder-CSDarkGray" : "placeholder-CSgreen")
      ...
      key: option.value,
      className: classnames("p-[10px] text-sm hover:bg-CSListHover font-normal cursor-pointer flex",
      // Add 'flex' class
      {
...
class MultiSelectChip extends react.Component {
  ...
  render() {
    ...
    const selectedDisplay = selected.length > 0 ? react.createElement("div", {
      ...
      key: option,
      className: classnames("flex items-center badge bg-CSChipBG text-CSGrayChip border border-CSChipBorder rounded-sm px-1 mr-[5px] mb-2 text-[14px]", option.length > 8 && "max-w-[100px]")
      ...
      className: "flex items-center badge bg-CSChipBG text-CSDarkGray border border-CSChipBorder rounded-sm px-1 mr-[5px] mb-2 text-[14px]"
    }, "+", selected.length - 2)) : react.createElement("div", {
      className: classnames("text-CSDarkGray pb-2", open && "text-CSgreen")
    }, "Please Select...");
    return react.createElement("div", {
      ...
      onClick: this.handleToggleOpen,
      id: "select",
      className: classnames("flex justify-between bg-white border-b border-gray-300 text-CSDarkGray pt-2 pl-2 text-[14px] font-normal transition-colors duration-300", selected.length === 0 && "text-CSDarkGray", open && "text-CSgreen", !open ? "cursor-pointer" : "cursor-default", "hover:border-CSgreen")
    }, selectedDisplay, react.createElement(BiChevronDown, {
      size: 24,
      color: "black",
      className: classnames({
      ...
      className: classnames("absolute z-10 w-full bg-CSDropDownBG mt-[1px] overflow-y-auto shadow-md transition-transform", open ? "max-h-60 translate-y-0 transition-opacity opacity-100 duration-300" : "max-h-0 translate-y-20 transition-opacity opacity-0 duration-300", {
        "ease-out": open
      })
    }, react.createElement("li", {
      className: classnames("pt-3 pl-3 text-[14px] font-normal text-CSgreen cursor-pointer flex"),
      onClick: this.handleClearAll
    }, "Clear All"), options && options.map(option => react.createElement("li", {
      key: option.value,
      className: classnames("p-3 text-sm hover:bg-CSListHover font-normal cursor-pointer flex", {
...
class MultiSelectShift extends react.Component {
  constructor(props) {
    ...
    this.handleSelect = (value, index, shiftKey) => {
      ...
      if (shiftKey) {
        ...
        const {
          options
        } = this.props; // Access options from props
        updatedSelected = options.slice(start, end + 1).map(option => option.value);
  ...
  render() {
    ...
    return react.createElement("div", {
      ...
      onClick: event => this.handleSelect(option.value, index, event.shiftKey)
    }, option.label))));
  }
}
...
var b = "function" === typeof Symbol && Symbol.for,
  ...
  n$1$1 = b ? Symbol.for("react.forward_ref") : 60112,
  p$1$1 = b ? Symbol.for("react.suspense") : 60113,
  q$1$1 = b ? Symbol.for("react.suspense_list") : 60120,
  r$1$1 = b ? Symbol.for("react.memo") : 60115,
  t$1$1 = b ? Symbol.for("react.lazy") : 60116,
  v$1$1 = b ? Symbol.for("react.block") : 60121,
  w$1$1 = b ? Symbol.for("react.fundamental") : 60117,
  x$1$1 = b ? Symbol.for("react.responder") : 60118,
  y$1$1 = b ? Symbol.for("react.scope") : 60119;
function z$1$1(a) {
...
var Profiler$1 = g;
var StrictMode$1 = f;
var Suspense$1 = p$1$1;
var isAsyncMode = function (a) {
  return A$1$1(a) || z$1$1(a) === l;
};
var isConcurrentMode = A$1$1;
...
var isForwardRef = function (a) {
  return z$1$1(a) === n$1$1;
};
var isFragment = function (a) {
  return z$1$1(a) === e;
};
var isLazy = function (a) {
  return z$1$1(a) === t$1$1;
};
var isMemo = function (a) {
  return z$1$1(a) === r$1$1;
};
...
var isSuspense = function (a) {
  return z$1$1(a) === p$1$1;
};
var isValidElementType = function (a) {
  return "string" === typeof a || "function" === typeof a || a === e || a === m || a === g || a === f || a === p$1$1 || a === q$1$1 || "object" === typeof a && null !== a && (a.$$typeof === t$1$1 || a.$$typeof === r$1$1 || a.$$typeof === h || a.$$typeof === k || a.$$typeof === n$1$1 || a.$$typeof === w$1$1 || a.$$typeof === x$1$1 || a.$$typeof === y$1$1 || a.$$typeof === v$1$1);
};
var typeOf = z$1$1;
    ...
    if (!Array.isArray(expectedValues)) {
      if (process.env.NODE_ENV !== 'production') {
        if (arguments.length > 1) {
          printWarning$1$1('Invalid arguments supplied to oneOf, expected an array, got ' + arguments.length + ' arguments. ' + 'A common mistake is to write oneOf(x, y, z) instead of oneOf([x, y, z]).');
        } else {
...
var styles = {
  "container": "styles-module_container__DmMTy",
  "invalidLabel": "styles-module_invalidLabel__1Ij5o",
  "check": "styles-module_check__2kRvT",
  "border": "styles-module_border__18Hao",
  "invalidCheck": "styles-module_invalidCheck__1VHED",
  "dot": "styles-module_dot__f4ZVh",
  "__radio": "styles-module___radio__WyngD",
  "checked": "styles-module_checked__kAlPq"
};
class Radio extends react$1.Component {
  constructor(props) {
    super(props);
  }
  render() {
    ...
    return /*#__PURE__*/react$1.createElement("div", {
      ...
      type: "radio",
      id: id,
      checked: mydefaultChecked === "true" ? true : mydefaultChecked === "false" && false
    }, this.props)), /*#__PURE__*/react$1.createElement("label", {
      htmlFor: id,
...
var styles$1 = {
  "__checkBox": "styles-module___checkBox__3UZcR",
  "__label": "styles-module___label__3xa6L",
  "__checkBoxDiv": "styles-module___checkBoxDiv__1Gmnc",
  "shrinkBounce": "styles-module_shrinkBounce__1vs_r",
  "checkboxCheck": "styles-module_checkboxCheck__3-Wfu",
  "intermediate": "styles-module_intermediate__PtTaV",
  "intermediateCheck": "styles-module_intermediateCheck__1EjVF",
  "__checkBoxInvalid": "styles-module___checkBoxInvalid__1NWl3"
};
class CheckBox extends react$1.Component {
  constructor(props) {
    super(props);
  }
  render() {
    ...
    return /*#__PURE__*/react$1.createElement(react$1.Fragment, null, /*#__PURE__*/react$1.createElement("input", _extends({
      className: `${className} ${styles$1.__checkBox} ${variant === "invalid" && styles$1.__checkBoxInvalid} `,
      type: "checkbox",
      id: id
    }, this.props)), /*#__PURE__*/react$1.createElement("label", {
      className: `${styles$1.__label}`,
      htmlFor: id
    }, /*#__PURE__*/react$1.createElement("span", {
      className: `${styles$1.__checkBoxDiv} ${variant2 === "intermediate" && styles$1.intermediate}`
    }), label));
  }
}
CheckBox.propTypes = {
...
exports.MultiSelectCheck = MultiSelectCheck;
exports.MultiSelectChip = MultiSelectChip;
exports.MultiSelectSearch = MultiSelectSearch;
exports.MultiSelectShift = MultiSelectShift;
