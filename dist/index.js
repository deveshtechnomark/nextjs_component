...
var styles = {"my_input":"styles_my_input__2gebG"};
...
class ExampleComponent extends react.Component {
  ...
  render() {
    ...
    return react.createElement(react.Fragment, null, react.createElement("h1", null, "Input Mask"), type === "credit" && react.createElement(MaskedInput, {
      className: `${styles.my_input} ${className}`,
      mask: [/[1-9]/, /\d/, /\d/, /\d/, " ", /\d/, /\d/, /\d/, /\d/, " ", /\d/, /\d/, /\d/, /\d/, " ", /\d/, /\d/, /\d/, /\d/],
      placeholder: `xxxx xxxx xxxx 1234`
    }), type === "phone" && react.createElement(MaskedInput, {
      className: `${styles.my_input} ${className}`,
      mask: [/[1-9]/, /\d/, /\d/, /\d/, /\d/, ' ', /\d/, /\d/, /\d/, ' ', /\d/, /\d/, /\d/],
      placeholder: "9874 563 214"
    }), type === "time" && react.createElement(MaskedInput, {
      className: `${styles.my_input} ${className}`,
      mask: [/[1-9]/, /\d/, ':', /\d/, /\d/, ':', /\d/, /\d/],
      placeholder: `15:58:25`
    }), type === "date" && react.createElement(MaskedInput, {
      className: `${styles.my_input} ${className}`,
      mask: [/[1-9]/, /\d/, '/', /\d/, /\d/, '/', /\d/, /\d/]
    }), type === "delimiter" && react.createElement(MaskedInput, {
      className: `${styles.my_input} ${className}`,
      mask: [/\d/, /\d/, /\d/, '·', /\d/, /\d/, /\d/, '·', /\d/, /\d/, /\d/],
      placeholder: `Delimiter: '·'`
    }), type === "customDelimeter" && react.createElement(MaskedInput, {
      className: `${styles.my_input} ${className}`,
      mask: [/\d/, /\d/, /\d/, '.', /\d/, /\d/, /\d/, '.', /\d/, /\d/, /\d/, '-', /\d/, /\d/]
    }), type === "prefix" && react.createElement(MaskedInput, {
      className: `${styles.my_input} ${className}`,
      mask: [...array.slice(0, array.length), ' ', /[A-Za-z]/, /[A-Za-z]/, /[A-Za-z]/, // Include alphabetic characters
      ' ', /\d/, /\d/, /\d/, ' ', /\d/, /\d/, /\d/, ' ', /\d/, /\d/, /\d/, /\d/],
