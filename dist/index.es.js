...
var style$5 = {"indicate":"Badge-module_indicate__JzUaM","wave":"Badge-module_wave__Gb99R","indicateBorder":"Badge-module_indicateBorder__vaimu","waveLine":"Badge-module_waveLine__fbAc5"};
...
var Badge = function Badge(_a) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    style: variant === "pill" ? {
      ...
      color: "".concat(effect ? getColor(badgetype) : ""),
      background: "".concat(getColor(badgetype), "0D")
    } : {
      backgroundColor: "".concat(getColor(badgetype))
    },
    className: "".concat(variant === "pill" ? "px-5 py-[10px] h-[27px] w-[82px] border rounded-[33px] text-[14px] font-normal leading-[16.8px] tracking-[0.28px]" : "h-[18px] w-[18px] border-none rounded-full text-white text-[10px] font-semibold leading-[9px] tracking-[0.8px]", " flex items-center justify-center")
  }, variant === "dot" ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", {
    style: variant === "dot" && effect ? {
      borderColor: "".concat(getColor(badgetype)),
      boxShadow: "0 0 0 0 ".concat(getColor(badgetype))
    } : {
      animation: "none"
    },
    className: style$5.indicate
  }, parseInt(text) > 99 ? "99+" : text, effect && /*#__PURE__*/React.createElement("span", {
    className: "".concat(style$5.indicateBorder)
  }))) : text);
};
...
var CheckBox = function CheckBox(_a) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "h-5 m-0 p-0 w-fit relative flex justify-start items-center ".concat(className)
...
var Pagination = function Pagination(props) {
  ...
  var arrowButtonStyle = "p-[4px] hover:bg-whiteSmoke rounded cursor-pointer";
  // common style for pages button in space variant
  var pagesSpaceStyle = "py-[1px] px-[9px] rounded text-[14px] font-proxima";
  // Common Style for first page number in variant - without space
  var firstPageNumStyle = "py-[1px] px-[9px] rounded-l-lg text-[14px] font-proxima ml-2";
  // Common style for last page number in variant - without space
  var lastPageNumStyle = "py-[1px] px-[9px] rounded-r-lg text-[14px] font-proxima mr-2";
  // common Style for Middle page numbers for variant without space
  var middlePageNumStyle = "py-[1px] px-[9px] text-[14px] font-proxima";
  ...
  var defaultPageNumSpaceStyle = "text-darkCharcoal bg-pureWhite border border-lightSilver hover:bg-whiteSmoke";
  // Style for default page numbers for variant without space
  var defaultPageNumStyle = "text-darkCharcoal bg-pureWhite border-t border-r border-b border-lightSilver hover:bg-whiteSmoke";
  ...
  space ? /*#__PURE__*/React.createElement("div", {
    ...
    className: "text-[20px]"
  }, /*#__PURE__*/React.createElement(ChevronsLeft, null))), /*#__PURE__*/React.createElement("button", {
    className: "".concat(arrowButtonStyle, " ").concat(currentPage === 1 ? "text-slatyGrey" : "text-darkCharcoal"),
    onClick: function onClick() {
      return handlePrevPage();
    },
    ...
    return /*#__PURE__*/React.createElement("button", {
      key: pageNumber,
      className: "".concat(pagesSpaceStyle, " ").concat(currentPage === pageNumber ? currentPageNumStyle : "text-darkCharcoal hover:bg-whiteSmoke", " ").concat(isSmallScreen ? "ml-1" : "ml-2"),
      onClick: function onClick() {
        return handleClick(Number(pageNumber));
      },
      disabled: currentPage === pageNumber || pageNumber === "..."
...
var Radio = function Radio(_a) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "".concat(styles$3.container, " relative min-w-fit w-full flex")
  }, /*#__PURE__*/React.createElement("input", __assign({
    className: "".concat(styles$3.__radio, " absolute left-5"),
    type: "radio",
    id: id
  }, props)), /*#__PURE__*/React.createElement("label", {
    htmlFor: id,
    className: variant === "invalid" ? styles$3.invalidLabel : ""
  }, /*#__PURE__*/React.createElement("svg", {
    className: "".concat(styles$3.check, " ").concat(variant === "invalid" ? styles$3.invalidCheck : ""),
    viewBox: "0 0 40 40"
...
var Rating = function Rating(_a) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, {
      ...
      className: "".concat(styles$2.comment_stars_input, " ").concat(item.isHalf ? styles$2.is_half : "", " ").concat(icon === "heart" ? styles$2.comment_stars_input_heart : "", " hidden"),
      type: "radio",
      ...
      className: "".concat(styles$2.comment_stars_view, " ").concat(item.isHalf ? styles$2.is_half : "", " ").concat(icon === "heart" ? styles$2.comment_stars_view_heart : ""),
...
var Select = function Select(_a) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    className: classNames("relative font-medium w-full flex-row border-b border-gray-300 hover:border-primary transition-colors duration-300 ".concat(className), inputValue && "border-primary"),
    ref: selectRef
  }, label && /*#__PURE__*/React.createElement("label", {
    ...
    className: classNames("flex-grow outline-none bg-white text-darkCharcoal py-1 px-2 text-[14px] font-normal font-proxima w-full", open && "text-primary", !open ? "cursor-pointer" : "cursor-default", !open ? "placeholder-darkCharcoal" : "placeholder-primary")
  }), /*#__PURE__*/React.createElement("div", {
    onClick: handleToggleOpen,
...
var MultiSelect = function MultiSelect(_a) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    htmlFor: id
  }, label ? label : "label", required && "*"), /*#__PURE__*/React.createElement("div", {
    ...
    className: classNames("flex-grow bg-white outline-none text-darkCharcoal py-1 px-2 text-[14px] font-normal font-proxima", open && "text-primary", !open ? "cursor-pointer" : "cursor-default", !open ? "placeholder-darkCharcoal" : "placeholder-primary")
  }), /*#__PURE__*/React.createElement("div", {
    onClick: handleToggleOpen,
    className: classNames("text-[1.5rem] text-darkCharcoal cursor-pointer", {
      "rotate-180": open
...
var MultiSelectChip = function MultiSelectChip(_a) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    onClick: handleToggleOpen,
    className: "".concat(classNames("flex justify-between bg-white border-b py-1 pl-2 text-[14px] font-normal font-proxima transition-colors duration-300", open ? "text-primary cursor-default" : selected.length === 0 && "text-darkCharcoal cursor-pointer", selected.length > 0 ? "border-primary" : "border-lightSilver", "hover:border-primary"), " ").concat(className)
...
var Tooltip = function Tooltip(_a) {
  var content = _a.content,
    ...
    children = _a.children;
  return /*#__PURE__*/React.createElement("div", {
    className: "".concat(styles$1.tooltip, " relative cursor-pointer p-2 text-sm sm:text-base max-w-fit")
  }, /*#__PURE__*/React.createElement("span", {
    className: "flex justify-center items-center tooltipText absolute bg-[#bcf1e8] w-max max-w-[300px] text-darkCharcoal whitespace-nowrap p-[10px] border border-primary rounded-md opacity-0 before:absolute before:w-3 before:h-3 before:bg-[#bcf1e8] before:border-t before:border-primary before:border-r ".concat(position === "top" && "".concat(styles$1.top, " hidden left-1/2 transform -translate-x-1/2 before:left-1/2 before:-translate-x-1/2 before:bottom-[-7px] before:transform before:rotate-[135deg]"), " \n        ").concat(position === "bottom" && "".concat(styles$1.bottom, " hidden left-1/2 transform -translate-x-1/2 before:left-1/2 before:-translate-x-1/2 before:top-[-7px] before:transform before:rotate-[-45deg]"), " \n        ").concat(position === "left" && "".concat(styles$1.left, " hidden top-1/2 transform -translate-y-1/2 before:top-1/2 before:-translate-y-1/2 before:right-[-7px] before:transform before:rotate-[45deg]"), " \n        ").concat(position === "right" && "".concat(styles$1.right, " hidden top-1/2 transform -translate-y-1/2 before:top-1/2 before:-translate-y-1/2 before:left-[-7px] before:transform before:rotate-[-135deg]")),
    style: {
      wordWrap: "break-word",
      whiteSpace: "unset"
    }
...
var Table = function Table(props) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "w-full ".concat(props.className)
  ...
  }, props.expandable && /*#__PURE__*/React.createElement("th", null), props.selected && /*#__PURE__*/React.createElement("th", {
    className: "sm:w-[56px]"
    ...
    return /*#__PURE__*/React.createElement("th", {
      ...
      className: "flex items-center"
    }, header, props.sortable && /*#__PURE__*/React.createElement("span", {
    ...
    }, props.expandable && /*#__PURE__*/React.createElement("td", {
      className: "sm:w-[56px]"
    }, /*#__PURE__*/React.createElement("button", {
      onClick: function onClick() {
    ...
    }, /*#__PURE__*/React.createElement(ChevronIcon, null))), props.selected && /*#__PURE__*/React.createElement("td", {
      className: "sm:w-[56px]"
    }, /*#__PURE__*/React.createElement(CheckBox, {
      id: index.toString(),
    ...
    })), props.expandable && expandedRows[index] && /*#__PURE__*/React.createElement("tr", {
      className: "p-4"
    }, props.expandable && /*#__PURE__*/React.createElement("th", null), props.headers.map(function (header) {
      return /*#__PURE__*/React.createElement("td", {
        key: header,
        className: "py-[19px] sm:py-[12px] px-[20px] sm:text-base font-normal"
      }, /*#__PURE__*/React.createElement("span", {
...
var Toast = /** @class */function (_super) {
  ...
  Toast.showToast = function (type, message, text, duration) {
    ...
    closeButton.className = "absolute top-[50%] -translate-y-[50%] right-[20px] w-15 h-15 bg-transparent border-none text-base cursor-pointer pl-10 text-xs sm:text-base";
