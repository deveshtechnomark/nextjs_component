...
class MultiSelectChip extends react.Component {
  ...
  render() {
    ...
    const selectedDisplay = selected.length > 0 ? react.createElement("div", {
      ...
      className: classnames("text-CSDarkGray pb-2 font-proxima", open && "text-CSgreen")
    }, "Please Select...");
    return react.createElement("div", {
      ...
      onClick: this.handleToggleOpen,
      className: classnames("flex justify-between bg-white border-b border-gray-300 text-CSDarkGray pt-2 pl-2 text-[16px] font-normal font-proxima transition-colors duration-300", selected.length === 0 && "text-CSDarkGray", open && "text-CSgreen", !open ? "cursor-pointer" : "cursor-default", "hover:border-CSgreen")
...
export { MultiSelectChip, MultiSelectSearch, Select };
