...
function S$1(a, b, d, c) {
  ...
  if (Array.isArray(a)) for (var h = 0; h < a.length; h++) {
    ...
    var f = b + T$1(e, h);
    g += S$1(e, f, d, c);
  } else if (null === a || "object" !== typeof a ? f = null : (f = A$1 && a[A$1] || a["@@iterator"], f = "function" === typeof f ? f : null), "function" === typeof f) for (a = f.call(a), h = 0; !(e = a.next()).done;) e = e.value, f = b + T$1(e, h++), g += S$1(e, f, d, c);else "object" === e && (d = "" + a, B$1("31", "[object Object]" === d ? "object with keys {" + Object.keys(a).join(", ") + "}" : d, ""));
  return g;
}
function U$1(a, b, d) {
