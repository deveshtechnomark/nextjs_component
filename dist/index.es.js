...
class Accordion extends react.Component {
  constructor(props) {
    ...
    this.toggleAccordion = index => {
      ...
      if (isActive) {
        ...
        this.setState({
          activeAccordions: [...activeAccordions, index]
        });
      }
    };
  ...
  render() {
    ...
    return /*#__PURE__*/react.createElement("div", {
      ...
      className: "w-full"
    }, dataCollection.map((item, index) => /*#__PURE__*/react.createElement("div", {
      key: index,
      className: `border border-transparent text-[14px] md:text-[16px] ${activeAccordions.includes(index) ? "border-b-textColor" : "border-b-gray-300"} cursor-pointer`,
      onClick: one ? () => this.toggleAccordionOne(index) : () => this.toggleAccordion(index)
    }, /*#__PURE__*/react.createElement("div", {
      className: `flex justify-between py-4 px-3 hover:bg-hoverColor ${activeAccordions.includes(index) ? "bg-bgColor" : ""}`
    }, /*#__PURE__*/react.createElement("p", {
      className: `${activeAccordions.includes(index) ? "text-textColor " : "text-textColor"} font-medium`
    }, item.question), /*#__PURE__*/react.createElement("span", {
      className: "flex justify-center items-center"
    }, activeAccordions.includes(index) ? /*#__PURE__*/react.createElement("span", null, icon ? /*#__PURE__*/react.createElement(FiMinus, null) : /*#__PURE__*/react.createElement(BsChevronUp, null)) : /*#__PURE__*/react.createElement("span", null, icon ? /*#__PURE__*/react.createElement(BsPlusLg, null) : /*#__PURE__*/react.createElement(BsChevronDown, null)))), /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("p", {
      className: `text-textColor px-3 ${activeAccordions.includes(index) ? "my-2" : ""}`
