...
function (_React$Component) {
  ...
  function Accordion(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleClickOutside", function (event) {
      if (_this.accordionRef.current && !_this.accordionRef.current.contains(event.target)) {
        _this.setState({
          openIndexes: []
        });
      }
    ...
    _defineProperty(_assertThisInitialized(_this), "handleAccordionClick", function (index) {
      _this.setState(function (prevState) {
        var openIndexes = prevState.openIndexes;
        var indexPosition = openIndexes.indexOf(index);
        var newOpenIndexes = indexPosition === -1 ? [].concat(_toConsumableArray(openIndexes), [index]) : openIndexes.filter(function (item) {
          return item !== index;
        });
        return {
    ...
    _defineProperty(_assertThisInitialized(_this), "isAccordionOpen", function (index) {
      var openIndexes = _this.state.openIndexes;
      return openIndexes.includes(index);
    });

    _defineProperty(_assertThisInitialized(_this), "renderIcon", function (index) {
      var icon = _this.props.icon;

      var isAccordionOpen = _this.isAccordionOpen(index);

      if (icon === 'plus') {
        return isAccordionOpen ? react.createElement(FaMinus, null) : react.createElement(FaPlus, null);
      } else {
        return isAccordionOpen ? react.createElement(FaAngleUp, null) : react.createElement(FaAngleDown, null);
      }
    });
  ...
  _createClass(Accordion, [{
    ...
    value: function render() {
      ...
      var isAccordionOpen = this.isAccordionOpen(index);
      return react.createElement("div", {
        ...
        className: "accordion-item ".concat(isAccordionOpen ? 'open' : '')
      }, react.createElement("h2", {
        className: "accordion-header"
      }, react.createElement("div", {
        className: styles.acordianHeaderIcon
      }, react.createElement("button", {
        className: "accordion-button ".concat(isAccordionOpen ? 'active' : ''),
        type: "button",
        onClick: function onClick() {
          return _this2.handleAccordionClick(index);
        }
      }, heading, this.renderIcon(index)))), isAccordionOpen && react.createElement("div", {
...
function (_React$Component) {
  ...
  function Accordion(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleAccordionClick", function (id) {
      _this.setState(function (prevState) {
        return {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderIcon", function (id) {
      var icon = _this.props.icon;
      var activeAccordionId = _this.state.activeAccordionId;
      var isActive = activeAccordionId === id;

      if (icon === 'plus') {
        return isActive ? react.createElement(FaMinus, null) : react.createElement(FaPlus, null);
      } else {
        return isActive ? react.createElement(FaAngleUp, null) : react.createElement(FaAngleDown, null);
      }
    });
  ...
  _createClass(Accordion, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          heading = _this$props.heading,
          description = _this$props.description;
      var activeAccordionId = this.state.activeAccordionId;
      var isActive = activeAccordionId === heading;
      return react.createElement("div", {
        className: "row",
        ref: this.accordionRef
      }, react.createElement("div", {
        ...
        className: "accordion-item ".concat(isActive ? 'open' : '')
      }, react.createElement("h2", {
        className: "accordion-header"
      }, react.createElement("div", {
        className: styles.acordianHeaderIcon
      }, react.createElement("button", {
        className: "accordion-button ".concat(isActive ? 'active' : ''),
        type: "button",
        onClick: function onClick() {
          return _this2.handleAccordionClick(heading);
        }
      }, heading, this.renderIcon(heading)))), isActive && react.createElement("div", {
        className: "accordion-collapse"
      }, react.createElement("div", {
        className: "accordion-body"
      }, description))))));
...
export { Accordion, Accordion$1 as MultiAccordion };
