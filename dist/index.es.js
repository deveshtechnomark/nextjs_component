...
import { BsFillEyeSlashFill, BsFillEyeFill, BsCheckLg, BsDot } from 'react-icons/bs';
...
var Password = function Password(_a) {
  ...
  }, React.createElement(BsFillEyeSlashFill, null)) : React.createElement("span", {
    className: "absolute top-9 right-1 text-md sm:text-lg ".concat(err ? "text-error" : "text-textDefault"),
    onClick: function onClick() {
      return setType("password");
    }
  }, React.createElement(BsFillEyeFill, null)), open && React.createElement(React.Fragment, null, React.createElement("div", {
