...
var Toast = /** @class */function (_super) {
  ...
  Toast.showToast = function (type, message, text, duration) {
    ...
    toastElement.className = "flex flex-col text-xs sm:text-base m-[6px] p-[12px] px-[16px] rounded-md text-white font-semibold min-w-15rem relative ".concat(type === "error" ? "bg-errorColor !text-darkRed" : type === "warning" ? "bg-warningColor !text-darkOrange" : type === "info" ? "bg-infoColor !text-darkBlue" : "bg-primary !text-pureWhite");
