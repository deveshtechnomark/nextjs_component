...
class Toast extends react.Component {
  static showToast(type, message, text, duration = 5000) {
...
`;
    ...
    toastElement.className = `flex flex-col text-base m-[6px] p-[12px] px-[16px] rounded-md text-white font-semibold min-w-15rem relative ${type === "error" ? "bg-rose-200 !text-red-500" : type === "warning" ? "bg-amber-100 !text-yellow-900" : type === "info" ? "bg-indigo-50 !text-blue-700" : "bg-teal-500 !text-white"}`;
    ...
    messageElement.innerHTML = `
     <span>${type === "error" ? errorIcon : type === "warning" ? warningIcon : type === "info" ? infoIcon : successIcon}</span>
  ...
  render() {
    ...
    return react.createElement("div", {
      ...
      className: `flex flex-col fixed select-none animate-slideDown ${position === "top_right" && "top-2 right-5"} ${position === "bottom_right" && "bottom-2 right-5"} ${position === "top_left" && "top-2 left-5"} ${position === "bottom_left" && "bottom-2 left-5"} ${position === "top_center" && "left-1/2 transform -translate-x-1/2"} ${position === "bottom_center" && "left-1/2 transform -translate-x-1/2 bottom-2"}`
    });
  }
}
