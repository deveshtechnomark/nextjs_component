...
class Alert extends react.Component {
  ...
  render() {
    ...
    return react.createElement("div", {
      ...
      className: `fixed select-none animate-slideDown ${position === "top_right" && "top-2 right-5"} ${position === "bottom_right" && "bottom-2 right-5"} ${position === "top_left" && "top-2 left-5"} ${position === "bottom_left" && "bottom-2 left-5"} ${position === "top_center" && "left-1/2 transform -translate-x-1/2"} ${position === "bottom_center" && "left-1/2 transform -translate-x-1/2 bottom-2"}`
    });
  }
}
