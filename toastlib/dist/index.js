...
var Success$1 = React__default.memo(Success);
...
var Close$1 = React__default.memo(Close);
...
var Info$1 = React__default.memo(Info);
...
var Warning$1 = React__default.memo(Warning);
...
var classes = {"toastContainer":"_1CFbT","top_left":"_tmTHp","top_center":"_Dz971","top_right":"_1BNRK","bottom_left":"_1QRFK","bottom_center":"_2y-Yq","bottom_right":"_duR0L","toast":"_3KnTL","default":"_3UK6o","success":"_2iiDh","error":"_3fyPz","info":"_1QKfK","warning":"_3vq3T","content":"_2jwZj","close":"_2I1sI","icon":"_2Vept"};
...
var Toast = function Toast(_ref) {
  ...
  return React__default.createElement("div", {
    className: classes.toast + " " + (type === 'default' ? "" + classes["default"] : type === 'success' ? "" + classes.success : type === 'error' ? "" + classes.error : type === 'info' ? "" + classes.info : type === 'warning' ? "" + classes.warning : '')
  ...
  }, React__default.createElement("p", null, content)), React__default.createElement("div", {
...
var ToastContainer = function ToastContainer(_ref) {
  ...
  return React__default.createElement("div", {
    className: classes.toastContainer + " " + (position === 'top-right' ? classes.top_right : position === 'top-left' ? classes.top_left : position === 'top-center' ? classes.top_center : position === 'bottom-left' ? classes.bottom_left : position === 'bottom-center' ? classes.bottom_center : position === 'bottom-right' ? classes.bottom_right : 'bottom-left')
