...
const Pagination: React.FC<PaginationProps> = (props) => {
  ...
  const pagesSpaceStyle = `pt-[1px] pr-[9px] pb-[1px] pl-[9px] rounded text-[14px]`;

  // Common Style for first page number in variant - without space
  const firstPageNumStyle = `pt-[1px] pr-[9px] pb-[1px] pl-[9px] rounded-l-lg text-[14px]`;

  // Common style for last page number in variant - without space
  const lastPageNumStyle = `pt-[1px] pr-[9px] pb-[1px] pl-[9px] rounded-r-lg text-[14px]`;

  // common Style for Middle page numbers for variant without space
  const middlePageNumStyle = `pt-[1px] pr-[9px] pb-[1px] pl-[9px] text-[14px]`;
