...
const Timepicker24: React.FC<Timepicker24Props> = () => {
    ...
    const renderHourDigits24 = hourDigits24.map((digit, index) => (
        <div
            ...
            style={{
                transform: `${isDigit24 ? `rotate(${index * 30}deg) translate(0, -90px) rotate(${-index * 30}deg)` : `rotate(${index * 30}deg) translate(0,${isHour24Selected ? "-90px" : "-55px"}) rotate(${-index * 30}deg)`}`,
                top: `46%`,
                left: '47%'
            }}
            ...
            <div className="flex flex-col items-center justify-center mt-3">
                ...
                {!showMinuteDigits && showHourDigits && (
                    <>
                        ...
                        <div className={`${isHour24Selected ? `w-56 h-56 -top-56 ${styles.scaleUpDiv} ` : `w-32  h-32 ${!isDigit24 ? "-top-[179px] -left-[2px]" : "-top-[180px] left-[1px]"} bg-transparent `}  bg-lightGray rounded-full relative flex items-center justify-center`}>
                            <div className={`w-full h-full relative -left-1`}>
                                {renderHourDigits24}
