...
export default class Typography extends React.Component<TypographyProps> {
  render() {
    ...
    switch (type) {
      ...
      case "h2":
        Element = "h2";
        styles = " text-[28px] font-normal md:text-[32px]";
        break;
      case "h3":
        Element = "h3";
        styles = "text-[24px] font-normal md:text-[28px]";
        break;
      case "h4":
        Element = "h4";
        styles = "text-[20px] font-normal md:text-[24px]";
        break;
      case "h5":
        Element = "h5";
        styles = "text-[16px] font-normal md:text-[20px]";
        break;
      case "h6":
        Element = "h6";
