  ...
  return (
    <article>
      <div className='card-body'>
        <Typography type='h2'><b>Alerts</b></Typography>
        <p className='card-text'>
          <Typography type='h6' className='line_format'>Alert messages refer to notifications that are displayed to the user to provide <b>information, warnings, success, danger</b> or prompts for interaction.</Typography>
          ...
          <Typography className='line_format'> Please copy this line and import in out code for Alerts.</Typography>
